...
public class BLUE12BALLAUTO extends OpMode {
    ...
    private static final int TURRET_TARGET_TICKS = 103;
    ...
    private final Pose pose2End  = new Pose(45.3, 58,  Math.toRadians(180));
    private final Pose pose3End  = new Pose(12.8, 58,  Math.toRadians(180));
